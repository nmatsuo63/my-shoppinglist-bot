...
export declare type Property = ScalarProperty | CollectionProperty;
export declare type ScalarProperty = PrimitiveProperty | ComplexProperty | UnionProperty;
export declare type CollectionProperty = ListProperty | MapProperty | UnionProperty;
export declare type ListProperty = PrimitiveListProperty | ComplexListProperty;
export declare type MapProperty = PrimitiveMapProperty | ComplexMapProperty;
export declare type TagProperty = TagPropertyStandard | TagPropertyAutoScalingGroup | TagPropertyJson | TagPropertyStringMap;
...
export declare type TagPropertyName = keyof typeof tagPropertyNames;
