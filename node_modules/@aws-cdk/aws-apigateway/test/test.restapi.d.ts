...
declare const _default: {
    ...
    '"endpointConfiguration" can be used to specify endpoint types for the api'(test: Test): void;
    '"endpointConfiguration" can be used to specify vpc endpoints on the API'(test: Test): void;
    '"endpointTypes" and "endpointConfiguration" can NOT both be used to specify endpoint configuration for the api'(test: Test): void;
