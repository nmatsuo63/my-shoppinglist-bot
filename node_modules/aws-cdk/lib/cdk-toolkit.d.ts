...
import { BootstrapEnvironmentProps } from '../lib';
...
export declare class CdkToolkit {
     ...
     */
    bootstrap(environmentGlobs: string[], toolkitStackName: string, roleArn: string | undefined, useNewBootstrapping: boolean, props: BootstrapEnvironmentProps): Promise<void>;
