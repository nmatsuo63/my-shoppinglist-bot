...
export declare class SdkProvider {
     ...
     */
    forEnvironment(accountId: string | undefined, region: string | undefined, mode: Mode): Promise<ISDK>;
    /**
     ...
     */
    withAssumedRole(roleArn: string, externalId: string | undefined, region: string | undefined): Promise<SDK>;
    /**
     ...
     */
    resolveEnvironment(accountId: string | undefined, region: string | undefined): Promise<cxapi.Environment>;
    resolveEnvironmentObject(env: cxapi.Environment): Promise<cxapi.Environment>;
    /**
